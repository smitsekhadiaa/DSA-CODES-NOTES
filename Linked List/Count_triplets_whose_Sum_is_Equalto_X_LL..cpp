// Count triplets in a sorted doubly linked list whose sum is equal to a given value x  VVIMP
...
// Using three nested loops generate all triplets and check whether elements in the triplet sum up to x or not.z
...
// ANALYSIS OF METHOD 1 (3 NESTED FOR LOOPS)
// TIME: O(n^3) as 3 nested for loops
// SPACE: O(1)

// Method 2 (HASHING USING UNSORTED MAPS): 
...
// ANALYSIS OF METHOD 2 (HASH MAPS)
// TIME: O(n^2)
// SPACE: O(n)  //as n sized hash map is used to store data
...
// ANALYSIS OF METHOD 3 (2 POINTER APPROACH)
// TIME: O(n^2)  
